...
@everywhere function reuse_sim_data(n_prop::Int64=2,a0::Float64=0.1,n_worlds::Int64=5,nrsim::Int64=1,filename::String="./data/simdata-n2-a0_0.1_n_worlds5simnr_1.csv")
...
function rerun_sim(numb_sim::Int64,a0::Float64,n_prop::Int64,nr_measures::Int64=4)
    ...
    for thresh in 1:length(trueEnoughProps)
        temp=Array{Float64,3}(undef,nr_measures,20,numb_sim)
        for i in 1:numb_sim
